...
public:
	MeshActor() = default;
	MeshActor(const float _radius, const size_t& _pointCount = 30, const string& _path = "", const float _lifespan = 0.0f, const IntRect& _rect = {}, const string& _name = "MeshActor");
	MeshActor(const Vector2f& _size, const string& _path = "", const float _lifespan = 0.0f, const TextureExtensionType& _textureType = PNG, const IntRect& _rect = {}, const string& _name = "MeshActor");
